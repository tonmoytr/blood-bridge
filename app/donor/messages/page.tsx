                ...
                <ScrollArea className="h-[500px]">
                  {threads.length === 0 ? (
                    <div className="p-8 text-center text-gray-500">
                      ...
                      <p className="text-sm mt-1">Accept a request to start chatting</p>
                    </div>
                  ) : (
                    threads.map((thread) => (
                      <div
                        ...
                        className={`p-4 border-b cursor-pointer hover:bg-gray-50 transition-colors ${
                          selectedThread?._id === thread._id
                            ? "bg-emergency-50 border-l-4 border-l-emergency-600"
                            : ""
                        }`}
                      >
                              ...
                              >
                                ...
                                <p
                                  className={`text-xs mt-1 ${
                                    isOwnMessage ? "text-emergency-100" : "text-gray-500"
                                  }`}
                                >
